...
PhongMaterial pm = new PhongMaterial(new double[] { 0.0, 0.2, 0.1 }, 0.05, 0.05, 0.3, 128);
pm.n = n;
pm.Kt = 0.9;
...
if (p.TryGetValue("mat", out string mat))
  switch (mat)
  {
    ...
    case "mirror":
      pm = new PhongMaterial(new double[] {1.0, 1.0, 0.8}, 0.01, 0.0, 0.95, 8192);
      break;
...
var advBackground = new AdvancedBackground(new double[] { 0.08, 0.17, 0.63 }, new double[] { 0.52, 0.64, 0.69 }, new double[] { 0.12, 0.08, 0.05}, Vector3d.UnitY);
